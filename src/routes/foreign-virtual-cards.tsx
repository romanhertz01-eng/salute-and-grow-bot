...
const faq: { q: string; a: string }[] = [
  ...
  },
  {
    ...
    a: "Не всегда. Ряд эмитентов принимает внутренний паспорт РФ, другим достаточно загранпаспорта, а некоторые продукты выпускаются вовсе без KYC. Смотрите поле «Документы» в карточке карты.",
  },
  {
